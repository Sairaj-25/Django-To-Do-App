...
class AuthenticationTests(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create_user(username='existinguser', email='exist@example.com', password='password123')
...
class TaskViewsTest(TestCase):
    ...
    def test_search_task_view(self):
        ...
        self.assertNotContains(response, "Initial Task") # Ensure the other task is filtered out
